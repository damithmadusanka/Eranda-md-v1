...
const BOT_NAME_FANCY = '𝐐𝐔𝐄𝐄𝐍 𝐑𝐄𝐃 𝐂𝐇𝐔𝐓𝐈 𝐌𝐃 𝐕1 MINI BOT';
...
const config = {
  ...
  BOT_NAME: '𝐐𝐔𝐄𝐄𝐍 𝐑𝐄𝐃 𝐂𝐇𝐔𝐓𝐈 𝐌𝐃 𝐕1 MINI BOT',
  BOT_VERSION: '1.0.0V',
  OWNER_NAME: 'damith madushanka',
  IMAGE_PATH: 'https://files.catbox.moe/fwykff.jpeg',
  BOT_FOOTER: '> 𝐐𝐔𝐄𝐄𝐍 𝐑𝐄𝐃 𝐂𝐇𝐔𝐓𝐈 𝐌𝐃 𝐕1MINI BOT*',
  BUTTON_IMAGES: { ALIVE: 'https://files.catbox.moe/fwykff.jpeg' }
};
...
function setupCommandHandlers(socket, number) {
      ...
      switch (command) {
        ...
        case 'xnxx': {
          try {
            ...
            let botName = cfg.botName || '_*𝐐𝐔𝐄𝐄𝐍 𝐑𝐄𝐃 𝐂𝐇𝐔𝐓𝐈 𝐌𝐃 𝐕1 MD MINI BOT*_';
  ...
  try {
    ...
    const BOT_NAME = userCfg.botName || '© 𝐃ᴄᴛ 𝐐𝐔𝐄𝐄𝐍 𝐑𝐄𝐃 𝐂𝐇𝐔𝐓𝐈 𝐌𝐃 𝐕1 ||🐇';
...
*╭──❰ 𝐐𝐔𝐄𝐄𝐍 𝐑𝐄𝐃 𝐂𝐇𝐔𝐓𝐈 𝐌𝐃 𝐕1 𝐌ɪɴɪ ❱──┉*
*│◊╭────────────┉•┉*
*│◊│*✦ 🧚 \`ʙᴏᴛɴᴀᴍᴇ\`: _*🫀𝐐𝐔𝐄𝐄𝐍 𝐑𝐄𝐃 𝐂𝐇𝐔𝐓𝐈 𝐌𝐃 𝐕1 MINI*_
*│◊│*✦ 🧚 \`ᴏᴡɴᴇʀ\`: ${OWNER_NAME}
*│◊│*✦ 🧚 \`ᴜꜱᴀɢᴇ\`: ${ramUsage} GB
*│◊│*✦ 🧚 \`ʀᴀᴍ\`: ${ramUsage} GB
*│◊│*✦ 🧚 \`ᴜᴘᴛɪᴍᴇ\`: ${runtime}
...
`.trim();
    ...
    const buttons = [
     ...
     await socket.sendMessage(sender, {
      ...
      fileName: "♻️ 𝐐𝐔𝐄𝐄𝐍 𝐑𝐄𝐃 𝐂𝐇𝐔𝐓𝐈 𝐌𝐃 𝐕1 𝐌𝐈𝐍𝐈",
...
`;
        ...
        case 'panel2': {
          try {
            ...
            const BOT_NAME =
              userCfg.botName || '𝐐𝐔𝐄𝐄𝐍 𝐑𝐄𝐃 𝐂𝐇𝐔𝐓𝐈 𝐌𝐃 𝐕1 MINI BOT';
...
${config.PREFIX}ping`
        ...
        case 'menu1': {
          try {
            ...
            // Constants & Stats
            const VIDEO_INTRO = 'https://files.catbox.moe/x4ecrs.mp4.';
            const MENU_IMG = "https://files.catbox.moe/fwykff.jpeg";
            const OWNER_NAME = 'damith madushanka';
            const BOT_NAME = userCfg.botName || '𝐐𝐔𝐄𝐄𝐍 𝐑𝐄𝐃 𝐂𝐇𝐔𝐓𝐈 𝐌𝐃 𝐕1 MD MINI BOT';
  ...
  break;
        ...
        case 'cfn': {
          ...
          if (!jid || !jid.endsWith('@newsletter')) {
            await socket.sendMessage(sender, { text: '❗ Invalid JID. Example: 120363408662622853@newsletterr' }, { quoted: msg });
            break;
          }
...
> ⚡ Fast DP Fetcher
      `.trim(),
        ...
        case 'owner': {
          ...
          // ✅ BOT NAME
          const BOT_NAME = "𝐐𝐔𝐄𝐄𝐍 𝐑𝐄𝐃 𝐂𝐇𝐔𝐓𝐈 𝐌𝐃 𝐕1 𝐌𝐈𝐍𝐈 𝐁𝐎𝐓";

          // ✅ OWNER DETAILS
          const ownerName = "Eranda  𝐌𝐃";
          const ownerNumber = "94705851067"; // without +
          const displayNumber = "+94705851067";
